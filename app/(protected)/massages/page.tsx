  ...
  if (!threads.length) {
    return (
      <main className="mx-auto max-w-6xl px-4 py-8 text-neutral-900 space-y-4">
        ...
        <p className="text-sm text-neutral-700">
          Åpne et medlem fra <Link href="/members" className="text-red-600 underline">medlemslisten</Link> og
          bruk knappen <span className="font-semibold">Messenger</span> for å starte en samtale.
        </p>
      </main>
    );
  }
